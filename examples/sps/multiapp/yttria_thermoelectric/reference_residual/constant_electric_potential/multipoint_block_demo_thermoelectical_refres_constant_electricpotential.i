...
[AuxKernels]
  ...
  [microapp_potential]
    ...
    coupled_variables = yttria_potential
    expression = 'yttria_potential*1e9' #convert from V to nV
  []
  [E_x]
  ...
  [microapp_current_density]
    ...
    coupled_variables = 'sigma_aeh E_y'
...
[BCs]
  ...
  #   cylinder_radius = 1 # I think this should help approximate the simplified radiative BC
...
[Postprocessors]
  ...
  [temperature_2979]
    ...
    elementid = 2979
  []
  [yttria_thermal_conductivity_2979]
    type = ElementalVariableValue
    elementid = 2979
    variable = yttria_thermal_conductivity
  []
  [yttria_specific_heat_capacity_2979]
    type = ElementalVariableValue
    elementid = 2979
    variable = yttria_specific_heat_capacity
  []
  [yttria_electrical_conductivity_2979]
    type = ElementalVariableValue
    elementid = 2979
    variable = yttria_electrical_conductivity
  []
