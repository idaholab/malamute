...
[Materials]
  ...
  [yttria_thermal_conductivity]
    ...
    args = 'yttria_thermal_conductivity_aeh'
    function = 'yttria_thermal_conductivity_aeh' #in W/(m-K) directly, for now
  ...
  [electrical_conductivity]
    ...
    function = 'yttria_sigma_aeh*1.602e-10' #converts to units of J/(V^2-m-s)
  ...
  [Q_SI]
    ...
    f_name = Q_SI
    args = 'Q_from_sub'
    function = 'Q_from_sub / 300 / 320 * 0.1602' #divide by domain size and unit conversion to go from eV/S to J/m^3/s
    outputs = 'exodus'
  []
[]
