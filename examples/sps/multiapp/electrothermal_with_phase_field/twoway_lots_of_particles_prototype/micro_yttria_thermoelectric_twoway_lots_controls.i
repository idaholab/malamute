...
[Materials]
  ...
  [ns_y_min]
    ...
    coupled_variables = 'gr0 gr1 gr2 gr3 gr4 T'
    constant_names = 'Ef_B c_GB   kB          Va_Y'
    constant_expressions = '4.37 0.1    8.617343e-5 0.03726'
    derivative_order = 2
    expression = 'c_B:=exp(-Ef_B/kB/T); bnds:=gr0^2 + gr1^2 + gr2^2 + gr3^2 + gr4^2;
  ...
  [electrical_conductivity]
    ...
    material_property_names = 'hs(gr0,gr1,gr2,gr3,gr4,phi) hv(gr0,gr1,gr2,gr3,gr4,phi) n_cat n_an chiDy_mag chi_cat chiDo_mag chi_an'
  ...
  [thermal_conductivity]
    ...
    coupled_variables = 'phi T'
    material_property_names = 'hs(gr0,gr1,gr2,gr3,gr4,phi) hv(gr0,gr1,gr2,gr3,gr4,phi)'
    ...
    expression = '(hv * prefactor_void + hs * prefactor_solid) / (T - 147.73)'
